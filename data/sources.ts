...
export const SOURCES: Source[] = [
  ...
  { kind: "official", title: "xAI's guides", href: "https://x.ai/bot/guides", description: "Official how-tos, linked from Getting started." },
...
export const SOURCE_GROUPS: { kind: SourceKind; title: string; blurb: string }[] = [
  ...
  { kind: "community", title: "Avatar research", blurb: "Open-source and community recreations of the avatar. Used for how it moves, not for what the product does." },
